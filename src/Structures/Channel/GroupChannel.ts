import { User, IGroupChannel, Client, CHANNELTYPES, IUser } from "../..";
...
export class GroupChannel extends Channel {
	...
	constructor(data: IGroupChannel, client: Client, public owner?: User) {
	...
	static async new(data: IGroupChannel, client: Client) {
